...
class EmailLogService
{
    ...
    public function getInfo($where, $columns = ['*'])
    {
        ...
        return EmailLog::query()->where($where)
            ->get($columns)
            ->toArray();
    ...
    {
        return EmailLog::query()->create($param);
    }
    ...
    public function del($where)
    {
        ...
        return EmailLog::query()->where($where)->update(['id_delete' => 1]);
    ...
    public function update($where, $param)
    {
        ...
        return EmailLog::query()->where($where)->update($param);
    }
}
