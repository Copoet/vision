...
class ArticleService
{
     ...
     *
     */
    public function getArticleInfo($where, $columns = ['*'])
    {

        return Article::query()->where($where)
            ->get($columns)
            ->toArray();
     ...
     */
    public function getArticleList($where, $columns = ['*'], $page, $pageSize)
    {
    ...
    {
        return Article::query()->create($param);
    }
    ...
    public function update($where, $param)
    {
        ...
        return Article::query()->where($where)->update($param);
    }
